...
<div class="container-fluid nopad">
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12 container-fixed">
			...
			<ul id="related-posts" class="row-fluid">
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more orderby="date" category="style" exclude="'.$wp_query->post->ID.'" button_label="More Shit"]');
			    ?>
			</ul>
		</div>
		...
		<div id="sidebar" class="sidebar col-md-4 pad40 hidden-sm">
			<h2>Related</h2>
			<?php query_posts('category_name=style&posts_per_page=4&offset=4'); ?>
			<?php if ( have_posts() ): ?>
