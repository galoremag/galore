			...
			<ul id="related-posts" class="row-fluid">
			  ...
			  <?php wp_reset_postdata(); ?>
				...
				<ul class="alm-listing alm-ajax">
					...
					$args = array( 'category_name' => 'editorial', 'post_type' => 'post', 'showposts' => 4, 'orderby' => 'date', 'order' => 'DESC', 'post__not_in' => array($this_post) );
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more offset="4" orderby="date" category="editorial" exclude="'.$wp_query->post->ID.'" button_label="Loading"]');
			    ?>
			</ul>
		</div>
