...
<div class="container-fluid nopad">
	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
			<h2 class="text-center">The Latest in <span><?php echo single_cat_title( '', false ); ?> <i class="fa fa-diamond"></i></span></h2>
			<hr>
			<ol>
			<?php query_posts('category_name=beauty&posts_per_page=4&offset=3&ignore_sticky_posts=true'); ?>
			<?php if ( have_posts() ): ?>
			...
			<?php 
			echo do_shortcode('[ajax_load_more category="beauty" button_label="Loading" offset="7" ignore_sticky_posts="true"]');
			?>
