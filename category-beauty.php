...
<div class="container-fluid nopad">
	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
			...
			<hr>
			<ol>
			<?php query_posts('category_name=beauty&posts_per_page=4&offset=3&ignore_sticky_posts=4'); ?>
			<?php if ( have_posts() ): ?>
			...
			<?php 
			echo do_shortcode('[ajax_load_more category="beauty" button_label="More Shit" offset="4"]');
			?>
