	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12 col-md-offset-2">
			...
			<ul id="related-posts" class="row-fluid">
				...
				<div id='div-gpt-ad-1465835581876-4' style='height:250px; width:300px;' class="visible-xs">
				...
				<div id='div-gpt-ad-1465835581876-1' style='height:250px; width:300px;' class="hidden-xs">
				<script type='text/javascript'>
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more offset="3" previous_post="true" previous_post_id="'.$wp_query->post->ID.'" orderby="date" category="pop" exclude="'.$wp_query->post->ID.'" button_label="Loading" repeater="template_2" post_type="post"]');
			    ?>
			</ul>
		</div>
	</div>
