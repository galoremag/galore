...
<div class="container-fluid nopad">
	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
			...
			<hr>
			<ol>
			<?php query_posts('category_name=pop&posts_per_page=4&offset=3&ignore_sticky_posts=true'); ?>
			<?php if ( have_posts() ): ?>
			...
			<?php 
			echo do_shortcode('[ajax_load_more category="pop" button_label="Loading" offset="7" ignore_sticky_posts="true"]');
			?>
