...
<div class="container-fluid">
    <div class="row-fluid">
        <div id="content" class="col-sm-10 col-sm-offset-1">
					<div id="buddypress">
						<?php
						/** Fires at the top of the BuddyPress member registration page template. @since 1.1.0 */
						...
						<div class="page" id="register-page">
							...
							<?php if ( 'registration-disabled' == bp_get_current_signup_step() ) : ?>
								...
								<?php
								/** Fires before the display of the registration disabled message. @since 1.5.0 */
								do_action( 'bp_before_registration_disabled' ); ?>
									<p><?php _e( 'User registration is currently not allowed.', 'buddypress' ); ?></p>
								<?php
								/** Fires after the display of the registration disabled message. @since 1.5.0 */
							...
							<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
								...
								<?php
								/** Fires before the display of member registration account details fields. @since 1.1.0 */
								...
								<div class="register-section" id="basic-details-section">
									...
									<?php
									/** Fires and displays any member registration username errors. @since 1.1.0 */
									do_action( 'bp_signup_username_errors' ); ?>
									<input type="text" name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" <?php bp_form_field_attributes( 'username' ); ?>/>
									<label for="signup_email"><?php _e( 'Email Address', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?></label>
									<?php
									/** Fires and displays any member registration email errors. @since 1.1.0 */
									do_action( 'bp_signup_email_errors' ); ?>
									<input type="email" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" <?php bp_form_field_attributes( 'email' ); ?>/>
									<label for="signup_password"><?php _e( 'Choose a Password', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?></label>
									<?php
									/** Fires and displays any member registration password errors. @since 1.1.0 */
									...
									<?php
									/** Fires and displays any member registration password confirmation errors. @since 1.1.0 */
									...
									<?php
									/** Fires and displays any extra member registration details fields. @since 1.9.0 */
									do_action( 'bp_account_details_fields' ); ?>
								</div><!-- #basic-details-section -->
								<?php
								/** Fires after the display of member registration account details fields. @since 1.1.0 */
								do_action( 'bp_after_account_details_fields' ); ?>
								<?php /***** Extra Profile Details ******/ ?>
								<?php if ( bp_is_active( 'xprofile' ) ) : ?>
									<?php
									/** Fires before the display of member registration xprofile fields. @since 1.2.4 */
									...
									<div class="register-section" id="profile-details-section">
										...
										<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
											<div<?php bp_field_css_class( 'editfield' ); ?>>
												...
												/** Fires before the display of the visibility options for xprofile fields. @since 1.7.0 */
												...
												<?php endif ?>
												<?php
												/** Fires after the display of the visibility options for xprofile fields. @since 1.1.0 */
										...
										<?php
										/** Fires and displays any extra member registration xprofile fields. @since 1.9.0 */
										do_action( 'bp_signup_profile_fields' ); ?>
									</div><!-- #profile-details-section -->
									<?php
									/** Fires after the display of member registration xprofile fields. @since 1.1.0 */
									do_action( 'bp_after_signup_profile_fields' ); ?>
								<?php endif; ?>
								<?php if ( bp_get_blog_signup_allowed() ) : ?>
									<?php
									/** Fires before the display of member registration blog details fields. @since 1.1.0 */
									...
									<div class="register-section" id="blog-details-section">
										...
										<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
											...
											<?php
											/** Fires and displays any member registration blog URL errors. @since 1.1.0 */
											...
											<?php
											/** Fires and displays any member registration blog title errors. @since 1.1.0 */
											do_action( 'bp_signup_blog_title_errors' ); ?>
											<input type="text" name="signup_blog_title" id="signup_blog_title" value="<?php bp_signup_blog_title_value(); ?>" />
											<span class="label"><?php _e( 'I would like my site to appear in search engines, and in public listings around this network.', 'buddypress' ); ?></span>
											<?php
											/** Fires and displays any member registration blog privacy errors. @since 1.1.0 */
											...
											<?php
											/** Fires and displays any extra member registration blog details fields. @since 1.9.0 */
											do_action( 'bp_blog_details_fields' ); ?>
										</div>
									</div><!-- #blog-details-section -->
									<?php
									/** Fires after the display of member registration blog details fields. @since 1.1.0 */
									do_action( 'bp_after_blog_details_fields' ); ?>
								<?php endif; ?>
								<?php
								/** Fires before the display of the registration submit buttons. @since 1.1.0 */
								do_action( 'bp_before_registration_submit_buttons' ); ?>
								<div class="submit">
									<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
								</div>
								<?php
								/** Fires after the display of the registration submit buttons. @since 1.1.0 */
							...
							<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
								...
								do_action( 'template_notices' ); ?>
								<?php
								/** Fires before the display of the registration confirmed messages. @since 1.5.0 */
								...
								<?php endif; ?>
								<?php
								/** Fires after the display of the registration confirmed messages. @since 1.5.0 */
								do_action( 'bp_after_registration_confirmed' ); ?>
							<?php endif; // completed-confirmation signup step ?>
							<?php
							/** Fires and displays any custom signup steps. @since 1.1.0 */
							do_action( 'bp_custom_signup_steps' ); ?>
							</form>
						</div>
						<?php
						/** Fires at the bottom of the BuddyPress member registration page template. @since 1.1.0 */
