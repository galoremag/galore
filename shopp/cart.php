...
<form id="cart" action="<?php shopp('cart','url'); ?>" method="post">
	...
	<?php while(shopp('cart','items')): ?>
		...
		<tr>
			...
			<td><?php shopp('cartitem','quantity','input=text&class=span1'); ?></td>
...
<div class="span3 pull-right">
	<?php shopp('cart','update-button', 'value=Update Cart&class=btn btn-small'); ?>
	<?php shopp('cart','promo-code','class=btn btn-small'); ?>
