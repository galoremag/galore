...
<div class="container-fluid nopad">
	<div class="row-fluid">
		...
		<?php echo do_shortcode( '[new_royalslider id="15"]' ); ?>
		</div>
	</div>
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
			<h1 class="text-center"><span><i class="fa fa-diamond"></i> <?php echo single_cat_title( '', false ); ?> <i class="fa fa-diamond"></i></span></h1>
			<h2 class="text-center">News & Information</h2>
			<hr>
			<ol>
			<?php query_posts('category_name=girl-cult&posts_per_page=4&offset=3&ignore_sticky_posts=true'); ?>
			<?php if ( have_posts() ): ?>
