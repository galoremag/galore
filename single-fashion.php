		...
		<div id="content" class="col-md-8 col-sm-12 col-md-offset-2">
			...
			<ul id="related-posts" class="row-fluid">
				...
				<ul class="container-fluid">
					...
					$args = array( 'category_name' => 'fashion', 'post_type' => 'post', 'showposts' => 3, 'orderby' => 'date', 'order' => 'DESC', 'post__not_in' => array($this_post) );
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more offset="3" orderby="date" category="fashion" previous_post="true" previous_post_id="'.$wp_query->post->ID.'" exclude="'.$wp_query->post->ID.'" button_label="Loading" repeater="template_2" post_type="post"]');
			    ?>
			</ul>
		</div>
	</div>
