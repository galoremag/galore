...
<div class="container-fluid nopad">
	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
				...
				<li class="post">
					<article class="row-fluid">
						...
						<div class="nopadright col-sm-7">
							...
							<p class="byline visible-xs pull-left nomarg">By <i class="pink fa fa-flash"></i> <?php the_author_posts_link(); ?></p>
			...
			<?php
			echo do_shortcode('[ajax_load_more category="collections" button_label="Loading" offset="7" ignore_sticky_posts="true" cache="true" cache_id="2718163069"]');
			?>
