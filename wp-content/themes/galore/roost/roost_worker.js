"use strict";
//var _roostSW = {version: 1, logging: true, appKey:"sl6otjre2knha1dhhy3trjd9y94q775x", host: "http://localhost:8081", baseURL: "http://localhost:8081"};

var _roostSW = {
    version: 2,
    logging: true,
    appKey: "sl6otjre2knha1dhhy3trjd9y94q775x",
        ...
        return fetch(_roostSW.host + "/api/browser/notifications?version=" + _roostSW.version + "&appKey=" + _roostSW.appKey + "&deviceID=" + encodeURIComponent(regID)).then(function(response) {
            return response.json().then(function(json) {
                ...
                for (var i = 0; i < json.notifications.length; i++) {
                    ...
                    var url = "/roost/roost.html?noteID=" + note.roost_note_id + "&sendID=" + note.roost_send_id + "&body=" + encodeURIComponent(note.body);
