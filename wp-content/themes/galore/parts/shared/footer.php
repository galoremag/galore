	                ...
	                <!- <form action="https://galoremag.createsend.com/t/i/s/tjcj/" method="post">
	                    ...
	                    <div class="form-group">
	                        <button class="btn btn-bp" type="submit">Subscribe</button>
									...
									<form action="//galoremag.us6.list-manage.com/subscribe/post?u=3fea351d2fae474dd55ec0526&amp;id=4d1c075505" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
									    <div id="mc_embed_signup_scroll">
												<div class="form-group">
													<input class="form-control" type="text" value="" placeholder="Full Name" name="FNAME" class="required" id="mce-FNAME">
												</div>
												<div class="form-group">
													<input class="form-control" type="email" value="" placeholder="Your Email" name="EMAIL" class="required email" id="mce-EMAIL">
												</div>
												<div id="mce-responses" class="clear">
													<div class="response" id="mce-error-response" style="display:none"></div>
													<div class="response" id="mce-success-response" style="display:none"></div>
												</div>    <!- real people should not fill this in and expect good things - do not remove this or risk form bot signups->
										    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_3fea351d2fae474dd55ec0526_4d1c075505" tabindex="-1" value=""></div>
										    <div class="clear">
													<input class="btn btn-bp" type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe">
												</div>
									    </div>
									</form>
									</div>
