	...
	<div class="row-fluid">
		...
		<div id="content" class="col-md-8 col-sm-12 col-md-offset-2">
			...
			<article itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
				...
				<div id="social-links">
					<ul id="post-social" class="post-social hidden-xs hidden-sm">
						...
						<li><a class="share-facebook" href="javascript:;" target="popup" onclick="recordShare(); window.open('https://twitter.com/share?url=<?php the_permalink(); ?>','Tweet this post','width=600,height=400')"><i class="fa fa-twitter"></i></a></li>
					</ul>
				</div>
			...
			<ul id="related-posts" class="row-fluid">
				...
				// }
				echo do_shortcode('[ajax_load_more offset="4" rderby="date" category="sex-dating" exclude="'.$wp_query->post->ID.'" button_label="Loading" cache="true" cache_id="6776227749"]');
				?>
			</ul>
		</div>
	</div>
