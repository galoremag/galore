			...
			<article>
				...
				<div id="social-links">
					<ul id="post-social" class="post-social hidden-xs hidden-sm">
						...
						<li><a class="share-facebook" href="#" target="popup" onclick="window.open('https://twitter.com/share?url=<?php the_permalink(); ?>','Tweet this post','width=600,height=400')"><i class="fa fa-twitter"></i></a></li>
					</ul>
				</div>
