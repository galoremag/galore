...
<div class="container-fluid nopad">
	<div class="row-fluid">
		...
		<?php echo get_new_royalslider(10); ?>
		</div>
	</div>
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
			...
			<?php
			echo do_shortcode('[ajax_load_more category="health" button_label="Loading" offset="7" ignore_sticky_posts="true" cache="true" cache_id="3081647542"]');
			?>
