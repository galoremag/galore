...
<div class="container-fluid">
	<div class="row-fluid">
		<div id="content" class="col-sm-8 col-sm-offset-2">
			...
			<hr>
			<ol>
			<?php query_posts('category_name=sex-dating&posts_per_page=4&offset=0'); ?>
			<?php if ( have_posts() ): ?>
			...
			<?php 
			echo do_shortcode('[ajax_load_more category="sex-dating" offset="4" button_label="More Shit"]');
			?>
