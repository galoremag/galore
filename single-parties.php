		...
		<div id="content" class="col-md-8 col-sm-12 container-fixed">
			...
			<ul id="related-posts" class="row-fluid">
				...
				<ul class="alm-listing alm-ajax">
					...
					$args = array( 'category_name' => 'parties', 'post_type' => 'post', 'showposts' => 4, 'orderby' => 'date', 'order' => 'DESC', 'post__not_in' => array($this_post) );
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more offset="4" orderby="date" category="parties" exclude="'.$wp_query->post->ID.'" button_label="Loading"]');
			    ?>
			</ul>
		</div>
