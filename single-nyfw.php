		...
		<div id="content" class="col-md-8 col-sm-12 col-md-offset-2">
			...
			<ul id="related-posts" class="row-fluid">
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more previous_post="true" previous_post_id="'.$wp_query->post->ID.'" orderby="date" category="nyfw" button_label="Loading" repeater="template_2" post_type="post"]');
			    ?>
			</ul>
		</div>
	</div>
