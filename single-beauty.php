	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12 container-fixed">
			...
			<ul id="related-posts" class="row-fluid">
				...
				<?php
				$args = array( 'category_name' => 'beauty', 'offset' => 4, 'post_type' => 'post', 'showposts' => 4, 'orderby' => 'date', 'order' => 'DESC' );
			    ...
			    <?php
					...
					echo do_shortcode('[ajax_load_more orderby="date" offset="8" category="beauty" exclude="'.$wp_query->post->ID.'" button_label="Loading"]');
			    ?>
			</ul>
		</div>
