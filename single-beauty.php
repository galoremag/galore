		...
		<div id="content" class="col-md-8 col-sm-12 container-fixed">
			...
			<ul id="related-posts" class="row-fluid">
			    ...
			    <?php
					...
					// }
					echo do_shortcode('[ajax_load_more previous_post="true" previous_post_id="'.$wp_query->post->ID.'" post_type="post" button_label="Loading" category="beauty" repeater="template_1"]');
