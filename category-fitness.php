...
<div class="container-fluid nopad">
	...
	<div class="row-fluid">
		<div id="content" class="col-md-8 col-sm-12">
			<h2 class="text-center">The Latest in <?php echo single_cat_title( '', false ); ?> <i class="fa fa-heartbeat"></i></h2>
			<hr>
			<ol>
			<?php query_posts('category_name=fitness&posts_per_page=4&offset=4'); ?>
			<?php if ( have_posts() ): ?>
			...
			<?php 
			echo do_shortcode('[ajax_load_more category="fitness" button_label="More Shit" offset="4"]');
			?>
